...
The system SHALL allow users to permanently remove a task from the list.

#### Scenario: Delete a task
- **WHEN** user selects delete action for a task
- **THEN** system removes the task from the list permanently

#### Scenario: Delete last remaining task
- **WHEN** user deletes the only task in the list
